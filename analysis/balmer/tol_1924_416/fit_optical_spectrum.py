...
def fit_muse_spectrum_old(coords, select_rad_pix, redshift, target_name):
...
def fit_muse_spectrum(coords, select_rad_pix, redshift, target_name):
    ...
    spectra_muse_err[np.isnan(spectra_muse_err)] = np.nanmax(spectra_muse_err)
...
coords_a = SkyCoord('19h27m58.382s -41d34m30.94s', unit=(u.hourangle, u.deg))
redshift = 0.0095   # redshift estimate from NED

fit_muse_spectrum(coords=coords_a, select_rad_pix=selection_radius_pix, redshift=redshift, target_name='TOL_1924_416')
