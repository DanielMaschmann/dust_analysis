...
rcsed_object = spec_fit.rcsed_spec_fit.RCSEDSpecFit(sdss_mjd=mjd_mrk33, sdss_plate=plate_mrk33,
                                                    sdss_fiberid=fiberid_mrk33, rcsed_version=1)
...
ebv_balmer = dust_class.get_balmer_extinct_beta_gamma(flux_h_beta_4863=fit_result_dict['flux_nl_4863_gauss_0'],
                                                      flux_h_gamma_4342=fit_result_dict['flux_nl_4342_gauss_0'])
ebv_balmer_err = dust_class.get_balmer_extinct_beta_gamma_err(flux_h_beta_4863=fit_result_dict['flux_nl_4863_gauss_0'],
                                                              flux_h_gamma_4342=fit_result_dict['flux_nl_4342_gauss_0'],
                                                              flux_h_beta_4863_err=fit_result_dict['flux_nl_4863_gauss_0_err'],
                                                              flux_h_gamma_4342_err=fit_result_dict['flux_nl_4342_gauss_0_err'])


balmer_dict = {
    'h_beta_flux': fit_result_dict['flux_nl_4863_gauss_0'],
    'h_gamma_flux': fit_result_dict['flux_nl_4342_gauss_0'],
    'h_beta_flux_err': fit_result_dict['flux_nl_4863_gauss_0_err'],
    'h_gamma_flux_err': fit_result_dict['flux_nl_4342_gauss_0_err'],
}
