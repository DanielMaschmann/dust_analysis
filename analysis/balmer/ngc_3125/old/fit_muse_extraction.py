...
coords_1_muse_pos_pix = wcs_muse.celestial.world_to_pixel(coords_1_muse)

mask_spectrum = (np.sqrt((x_data_muse - coords_1_muse_pos_pix[0]) ** 2 + (y_data_muse - coords_1_muse_pos_pix[1]) ** 2)
...
ebv_balmer = dust_class.get_balmer_extinct(flux_h_alpha_6565=h_alpha_flux,
