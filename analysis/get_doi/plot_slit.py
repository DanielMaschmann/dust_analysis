...
id_list = []
for target in file_name_dict.keys():
    print(target)
    if 'file_name_b' in file_name_dict[target].keys():
        hdu_hst_b = fits.open(file_name_dict[target]['file_name_b'])
        id_list.append(hdu_hst_b[0].header['PROPOSID'])

    if 'file_name_g' in file_name_dict[target].keys():
        hdu_hst_g = fits.open(file_name_dict[target]['file_name_g'])
        id_list.append(hdu_hst_g[0].header['PROPOSID'])

    if 'file_name_r' in file_name_dict[target].keys():
        hdu_hst_r = fits.open(file_name_dict[target]['file_name_r'])
        id_list.append(hdu_hst_r[0].header['PROPOSID'])

    if 'file_name_align_g140l' in file_name_dict[target].keys():
        hdu_g140l = fits.open(file_name_dict[target]['file_name_align_g140l'])
        id_list.append(hdu_g140l[0].header['PROPOSID'])
    if 'file_name_align_g430m' in file_name_dict[target].keys():
        hdu_g430m = fits.open(file_name_dict[target]['file_name_align_g430m'])
        id_list.append(hdu_g430m[0].header['PROPOSID'])
