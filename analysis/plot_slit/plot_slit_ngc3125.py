...
file_name_dict = {
    'ngc_3125': {
        'file_name_img': '/home/benutzer/data/observation/heII_paper/ngc3125/img/hst_10400_01_acs_hrc_f435w_drz.fits',
        'filter_name_img': 'F435W',
        ...
        'coords_img': '10h06m33.5s -29d56m09.0s',
        'coords_slit_center': '10h06m33.26s -29d56m06.76s',
        'coords_source_a': '10h06m33.263s -29d56m06.76s',
    }}

        # 'coords_img': '10h06m33.29s -29d56m06.8s',
        # 'coords_slit_center': '10h06m33.263s -29d56m06.76s',
        # 'coords_source_a': '10h06m33.263s -29d56m06.76s',
# slit_pos_g140l_pix_large  (array(598.49247772), array(399.10170889))
...
cutout_img_zoom = helper_func.get_img_cutout(img=img_data, wcs=wcs_img, coord=coords_slit_center_world, cutout_size=(1.5, 1.5))
