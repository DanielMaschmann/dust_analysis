...
file_name_dict = {
    'he2_10': {
        'file_name_img': '/home/benutzer/data/observation/heII_paper/he2_10/img/hst_06580_02_wfpc2_f555w_pc_drz.fits',
        'filter_name_img': 'F555W',
...
coords_zoom_position = SkyCoord(file_name_dict[target]['coords_zoom_position'], unit=(u.hourangle, u.deg))

cutout_img_large = helper_func.get_img_cutout(img=img_data, wcs=wcs_img, coord=coords_img_world, cutout_size=cutout_size)
cutout_img_zoom = helper_func.get_img_cutout(img=img_data, wcs=wcs_img, coord=coords_zoom_position, cutout_size=(2, 2))
...
peak_coords_zoom_world = cutout_img_zoom.wcs.pixel_to_world(peak_coords_zoom_pix[0][0], peak_coords_zoom_pix[1][0])
...
slit_pos_g140l_world = SkyCoord(ra=peak_coords_zoom_world.ra - ra_offset_g140l,
                                dec=peak_coords_zoom_world.dec - dec_offset_g140l)
slit_pos_g430m_world = SkyCoord(ra=peak_coords_zoom_world.ra - dec_offset_g430m,
                                dec=peak_coords_zoom_world.dec - ra_offset_g430m)
#
...
coords_source_c_world = SkyCoord(file_name_dict[target]['coords_source_c'], unit=(u.hourangle, u.deg))
coords_source_d_world = SkyCoord(file_name_dict[target]['coords_source_d'], unit=(u.hourangle, u.deg))
# convert to pixel
...
coords_source_c_pix = cutout_img_zoom.wcs.world_to_pixel(coords_source_c_world)
coords_source_d_pix = cutout_img_zoom.wcs.world_to_pixel(coords_source_d_world)
# plot circle
plotting_tools.plot_coord_circle(ax=ax_hst_zoom, pos=coords_source_a_world, rad=0.2, color='white',
                                 linestyle='-', linewidth=2, alpha=1., fill=False)
plotting_tools.plot_coord_circle(ax=ax_hst_zoom, pos=coords_source_b_world, rad=0.2, color='white',
                                 linestyle='-', linewidth=2, alpha=1., fill=False)
plotting_tools.plot_coord_circle(ax=ax_hst_zoom, pos=coords_source_c_world, rad=0.2, color='white',
                                 linestyle='-', linewidth=2, alpha=1., fill=False)
plotting_tools.plot_coord_circle(ax=ax_hst_zoom, pos=coords_source_d_world, rad=0.2, color='white',
                                 linestyle='-', linewidth=2, alpha=1., fill=False)


ax_hst_zoom.text(coords_source_a_pix[0] - 5, coords_source_a_pix[1] + 7, 'A',
                horizontalalignment='right', verticalalignment='bottom', color='white', fontsize=fontsize)
ax_hst_zoom.text(coords_source_b_pix[0] - 0, coords_source_b_pix[1] + 9, 'B',
                horizontalalignment='right', verticalalignment='bottom', color='white', fontsize=fontsize)
ax_hst_zoom.text(coords_source_c_pix[0] - 0, coords_source_c_pix[1] + 9, 'C',
                horizontalalignment='right', verticalalignment='bottom', color='white', fontsize=fontsize)
ax_hst_zoom.text(coords_source_d_pix[0] + 4, coords_source_d_pix[1] + 9, 'D',
                horizontalalignment='right', verticalalignment='bottom', color='white', fontsize=fontsize)


mean, median, std = sigma_clipped_stats(cutout_img_large.data, sigma=3.0)
# ax_hst_img.imshow(cutout_img_large.data, vmin=mean-std, vmax=mean+150*std, cmap='inferno')
# ax_hst_zoom.imshow(cutout_img_zoom.data, vmin=mean-std, vmax=mean+600*std, cmap='inferno')
...
ax_hst_img.imshow(np.log10(display_data_img), vmin=-2, vmax=2, cmap='inferno')
ax_hst_zoom.imshow(np.log10(display_data_zoom), vmin=-2, vmax=2, cmap='inferno')


ax_hst_img.set_title('He 2-10', fontsize=fontsize)
